...
import com.example.mainservice.Config.AuthenticationConstants;
import com.example.mainservice.DAO.mapper.UserMapper;
import com.example.mainservice.DTO.*;
import com.example.mainservice.Entity.RoleType;
...
import com.example.mainservice.Repository.UserStatisticRepository;
import com.example.mainservice.Service.JWTService;
import com.example.mainservice.Service.UserIService;
import com.example.mainservice.exception.UserServiceCustomException;
import com.example.mainservice.utility.EmailUtility;
import com.example.mainservice.utility.ResponseUtil;
import com.example.mainservice.utility.UserStatisticDailyRefreshUtil;
...
public class UserService implements UserIService {
    ...
    public List<UserStatistic> updateUserStatisticByDate(LocalDate startDate, LocalDate endDate) {
        ...
        // should not update yesterday, today and future data by filling in with
        // previous data
