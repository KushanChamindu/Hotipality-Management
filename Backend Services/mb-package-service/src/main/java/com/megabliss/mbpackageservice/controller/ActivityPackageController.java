...
public class ActivityPackageController {
    ...
    public ResponseEntity<ResponseModel<ActivityPackageDTO>> findActivitiesWithinDistance(
        ...
        return new ResponseEntity<>(activityPackageService.filteredActivityPackages(latitude, longitude, distance,
    ...
    public ResponseEntity<ResponseModel<ActivityPackageDTO>> getAllMyPackageActivities(
        ...
        ResponseModel<ActivityPackageDTO> packageActivities = activityPackageService.getMyPackageActivities(isActive,
                pageable);
