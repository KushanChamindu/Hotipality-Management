...
import com.megabliss.mbpackageservice.model.activitypackage.ActivityPackageRequirement;
import com.megabliss.mbpackageservice.model.activitypackage.ActivityPackageVideo;
...
public class ActivityPackageUpdateDTO {
    ...
    @Size(min = 3, max = 128, message = "Invalid Time Required Length : Activity Package Time Required must be " +
            "between 3-128 " +
            "characters")
    ...
    @NotNull(message = "Invalid description : Activity Package description cannot be null")
    @NotBlank(message = "Invalid description : Activity Package description cannot be blank")
    @Size(min = 3, max = 512, message = "Invalid description Length : Activity Package description must be between 3-512 characters")
