...
import com.megabliss.mbpackageservice.dao.mapper.PaymentDataMapper;
...
import com.megabliss.mbpackageservice.exception.BookingException;
...
import com.megabliss.mbpackageservice.model.activity.ActivitySpecialTime;
...
import com.megabliss.mbpackageservice.repository.BookingRepository;
...
import com.megabliss.mbpackageservice.utils.BookingUtils;
...
public class BookingServiceImpl implements BookingService {
    ...
    public ActivityBookingDTO bookActivity(ActivityBookingDTO activityBookingDTO) {
        ...
        if (Boolean.TRUE.equals(bookingActivity.getIsAlldayActivity())
            ...
            Booking bookingObject = Booking.builder().customerId(activityBookingDTO.getCustomerId())
                    ...
                    .bookingStatus(BookingStatus.REQUEST_PAYMENT).fromDate(activityBookingDTO.getFromDate())
    ...
    public ActivityBookingDTO bookOneTimeActivity(Activity activity, ActivityBookingDTO activityBookingDTO) {
        ...
        if (Boolean.TRUE.equals(activity.getIsAlldayActivity())
            ...
            List<ActivityBooking> activityBookingObject = Arrays
                    .asList(ActivityBooking.builder().quantity(activityBookingDTO.getQuantity())
                            .specialActivityTimeId(activityBookingDTO.getSpecialActivityTimeId())
                ...
                List<ActivityBooking> activityBookingObject = Arrays
                        .asList(ActivityBooking.builder()
                                ...
                                .activityTimeId(personalizedPackageActivityBind
                                        .getActivityTimeId())
                                .startTime(LocalDateTime.of(fromDate, activityTimes.get(0).getStartTime()))
                                .finishTime(LocalDateTime.of(fromDate, activityTimes.get(0).getEndTime()))
    ...
    public ResponseModel<Booking> getBookingByDate(String startDate, String endDate, String serviceProviderId,
        ...
        if (Boolean.TRUE.equals(isPay)) {
            getBookingByDate = bookingRepository.findBookingsByFromDateBetweenAndServiceProviderIdAndPaymentInfo_Status(
                    LocalDate.parse(startDate),
                    LocalDate.parse(endDate), serviceProviderId, "succeeded", pageable);
        } else {
    ...
    public ResponseModel<Booking> getHistoricalBookingByProviderId(String providerId, Boolean isPay,
        ...
        if (Boolean.TRUE.equals(isPay)) {
            retrieveHistoricalBooking = bookingRepository
                    .findBookingsByToDateBeforeAndServiceProviderIdAndPaymentInfo_Status(currentDate, providerId,
                            "succeeded", pageable);
        } else {
            retrieveHistoricalBooking = bookingRepository
                    .findBookingsByToDateBeforeAndServiceProviderId(currentDate, providerId, pageable);
        }
