...
public class BookingController {
        ...
        public ResponseEntity<ActivityBookingDTO> addActivityBooking(
                        @Valid @RequestBody ActivityBookingDTO bookingDTO) {
                if (bookingDTO.getSpecialActivityTimeId() != null && bookingDTO.getActivityTimeId() != null) {
                        ...
                        throw new IllegalArgumentException(
                                        "A one time activity cannot have activity times (recurring)");
                } else if (bookingDTO.getSpecialActivityTimeId() != null && !bookingDTO.getIsOneTime()) {
                        throw new IllegalArgumentException(
                                        "A normal activity (recurring) cannot have special activity times" +
                                                        "(one time)");
                }
        ...
        public ResponseEntity<ResponseModel<Booking>> getBookingByDate(
                ...
                return ResponseEntity.ok()
                                .body(bookingService.getBookingByDate(startDate, endDate, serviceProviderId, isPay,
                                                pageRequestData));
        ...
        public ResponseEntity<ResponseModel<Booking>> getHistoricalBookingsByProviderId(
                ...
                return ResponseEntity.ok()
                                .body(bookingService.getHistoricalBookingByProviderId(serviceProviderId, isPay,
                                                pageRequestData));
        }
