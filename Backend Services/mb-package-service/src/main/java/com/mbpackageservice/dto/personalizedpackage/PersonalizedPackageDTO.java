package com.mbpackageservice.dto.personalizedpackage;
...
@NoArgsConstructor
@AllArgsConstructor
public class PersonalizedPackageDTO {
    ...
    private List<PersonalizedPackageActivityBindDTO> personalizedPackageActivityBinds;
}
